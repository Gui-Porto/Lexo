    ...
    <div className="auth-root" style={{ display: "flex", minHeight: "100vh", fontFamily: F }}>
      ...
      <div className="auth-brand" style={{
        ...
        <div style={{ position: "relative", marginTop: "auto", paddingTop: 56 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginTop: 26, padding: "14px 16px", border: "1px solid #4d5757", borderRadius: 13, background: "#4d57570a" }}>
            <div style={{ width: 38, height: 38, borderRadius: "50%", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", font: `600 14px ${F}`, color: "#222f30", background: `linear-gradient(135deg,${AC},${AC2})` }}>
              {initials(name)}
            </div>
            <div style={{ minWidth: 0 }}>
              <div style={{ font: `600 13px ${F}`, color: "#ffffff", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{name}</div>
              <div style={{ font: `400 12px ${F}`, color: "#93a09f", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{email}</div>
            </div>
      ...
      <div className="auth-form" style={{ flex: 1.12, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "36px 52px", background: "#222f30", overflowY: "auto" }}>
        <div style={{ width: "100%", maxWidth: 440 }}>
          ...
          <form action={formAction} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 2, padding: "9px 14px 9px 9px", border: "1px solid #4d5757", borderRadius: 999, background: "#4d57570a", maxWidth: "100%", minWidth: 0 }}>
              <div style={{ width: 26, height: 26, borderRadius: "50%", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center", font: `600 11px ${F}`, color: "#222f30", background: `linear-gradient(135deg,${AC},${AC2})` }}>
                {initials(name)}
              </div>
              <span style={{ font: `500 13px ${F}`, color: "#ffffff", minWidth: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{email}</span>
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 10, height: 46, border: "1px solid #4d5757", borderRadius: 11, padding: "0 14px", background: "#222f30" }}>
                ...
                <input name="organizationName" type="text" required minLength={2} placeholder="Ex.: Andrade Advocacia" style={{ flex: 1, minWidth: 0, border: "none", background: "transparent", color: "#ffffff", font: `400 14px ${F}`, outline: "none" }} />
              </div>
            </div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
              ...
              <div>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  {teamSizeOpen && (
                    <div style={{ position: "absolute", top: "calc(100% + 4px)", left: 0, right: 0, background: "#222f30", border: "1px solid #4d5757", borderRadius: 11, overflow: "hidden", zIndex: 10 }}>
                      {TEAM_SIZES.map((opt) => (
                        <button
                          key={opt.value}
                          type="button"
            ...
            <button
              ...
              style={{
                ...
                background: pending ? "#283738" : `linear-gradient(135deg,${AC},${AC2})`,
